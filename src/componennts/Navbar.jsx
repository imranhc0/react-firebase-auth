	...
	<div className="container flex justify-between h-16 mx-auto">
		...
		<ul className="items-stretch hidden space-x-3 lg:flex">
		 ...
		 <div className="items-center flex-shrink-0 hidden lg:flex">
			...
			<NavLink to='registraion' className="self-center px-8 py-3 font-semibold rounded bg-violet-400 text-gray-900">Sign up</NavLink></> : <button onClick={handleSignOut} className="self-center px-8 py-3 font-semibold rounded bg-violet-400 text-gray-900">Sign Out</button>  }
		</div> 
